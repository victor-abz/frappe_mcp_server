...
import { getDocTypeSchema, getFieldOptions, FrappeApiError, getAllDocTypes, getAllModules } from "./frappe-api.js";
...
export async function handleSchemaToolCall(request) {
...
export function setupSchemaTools(server) {
    ...
    server.setRequestHandler(ReadResourceRequestSchema, async (request) => {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Error processing resource request: ${error.message}`);
        }
    });
}
